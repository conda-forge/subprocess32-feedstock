About subprocess32-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/subprocess32-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1971&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/subprocess32-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `subprocess32` can be installed with `conda`:
...
```
mamba install subprocess32
```

It is possible to list all of the versions of `subprocess32` available on your platform with `conda`:
...
```
mamba search subprocess32 --channel conda-forge
```
...
mamba repoquery search subprocess32 --channel conda-forge

# List packages depending on `subprocess32`:
mamba repoquery whoneeds subprocess32 --channel conda-forge

# List dependencies of `subprocess32`:
mamba repoquery depends subprocess32 --channel conda-forge
```
